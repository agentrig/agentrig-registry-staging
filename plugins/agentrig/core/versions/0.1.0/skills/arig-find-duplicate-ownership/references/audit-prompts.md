...
```text
Use $arig-find-duplicate-ownership to audit this codebase for duplicate ownership and hidden second sources of truth.
...
```text
Use $arig-find-duplicate-ownership to audit this layered application for duplicate ownership.
...
```text
Use $arig-find-duplicate-ownership to audit this codebase for duplicate ownership.
